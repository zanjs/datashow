...
function() {
	return window.DataShow = function(t) {
		"use strict";
		function e(e) {
		...
		return e.prototype = {
			...
			init: function() {
				this.scrolled = !1;
				var e = this;
				this.elems = Array.prototype.slice.call(this.docElem.querySelectorAll("[data-show]")),
				this.elems.forEach(function(t) {
					var o = t.getAttribute("data-show-id");
					o || (o = i++, t.setAttribute("data-show-id", o)),
			...
			parseLanguage: function(t) {
				...
				var i = t.getAttribute("data-show").split(/[, ]+/),
				o = {};
				return i = e(i),
			...
			update: function(t) {
				var e = this.genCSS(t),
				i = this.styleBank[t.getAttribute("data-show-id")];
				return null != i ? i += ";": i = "",
				t.getAttribute("data-show-initialized") || (t.setAttribute("style", i + e.initial), t.setAttribute("data-show-initialized", !0)),
				this.isElementInViewport(t, this.options.viewportFactor) ? t.getAttribute("data-show-complete") ? void 0 : this.isElementInViewport(t, this.options.viewportFactor) ? (t.setAttribute("style", i + e.target + e.transition), void(this.options.reset || setTimeout(function() {
					"" != i ? t.setAttribute("style", i) : t.removeAttribute("style"),
					t.setAttribute("data-show-complete", !0)
				},
				e.totalDuration))) : void 0 : void(this.options.reset && t.setAttribute("style", i + e.initial + e.reset))
			},
			genCSS: function(t) {
				var e, i, o = this.parseLanguage(t);
				o.enter ? (("top" == o.enter || "bottom" == o.enter) && (e = o.enter, i = "y"), ("left" == o.enter || "right" == o.enter) && (e = o.enter, i = "x")) : (("top" == this.options.enter || "bottom" == this.options.enter) && (e = this.options.enter, i = "y"), ("left" == this.options.enter || "right" == this.options.enter) && (e = this.options.enter, i = "x")),
